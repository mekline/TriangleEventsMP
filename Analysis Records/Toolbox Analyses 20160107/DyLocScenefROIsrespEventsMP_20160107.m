...
firstlevel_loc = 'firstlevel_DyLoc' % path to the first-level analysis directory for the lang localizer or whatever
...
MyOutputFolder = '/mindhive/evlab/u/mekline/Desktop/EventsMP/Toolbox/DyLocScenefROIsrespEventsMP_20160107_RESULTS' %Where should the results wind up?

loc_cons = {{'Scenes-Objects'}} %Which contrast used to localize issROIs?
...
what_parcels =  '/users/evelina9/fMRI_PROJECTS/ROIS/SCENEfROIs.img' %specify the full path to the *img or *nii file that will constrain the search for top voxels
