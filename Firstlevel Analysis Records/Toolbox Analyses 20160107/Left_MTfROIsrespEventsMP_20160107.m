...
MyOutputFolder = '/mindhive/evlab/u/mekline/Desktop/EventsMP/Toolbox/Left_MTfROIsrespEventsMP_20160107_RESULTS' %Where should the results wind up?
...
what_parcels =  '/users/evelina9/fMRI_PROJECTS/ROIS/SearchSpace_lMT.nii' %specify the full path to the *img or *nii file that will constrain the search for top voxels
